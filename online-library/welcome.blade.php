...
@csrf
    ...
    <input type="password" name='repeatPassword' id='repeatPassword' placeholder='Repeat password' class="form-control"><br>
    <button type='sybmit' class="form-control">Sing up</button>
</form>
    </body>
</html>
